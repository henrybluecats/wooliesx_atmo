package com.woolworths.android.digital.food.atompoc.widget;
...
public class CircularProgressDrawable extends Drawable {
	 ...
	 * drawable will show a 90 degree arc which will be spinning around the outer
	 ...
	 *
	 * @param ringWidth
	 *            Width of the filled ring
	 * @param circleScale
	 *            Scale difference between the outer ring and the inner circle
	 * @param outlineColor
	 *            Color for the outline color
	 * @param ringColor
	 *            Color for the filled ring
	 * @param centerColor
	 *            Color for the center element
	 */
	...
	public void draw(Canvas canvas) {
		...
		if (indeterminate) {
			canvas.drawArc(arcElements, progress, 120, false, paint);
		} else {
	 ...
	 * <p/>
	 * Otherwise the drawable will enter "loading mode" and a 90 degree arc will be
	 * able to be spinned around the inner circle.
	 * <p/>
	 * <b>By default, indeterminate mode is set to FALSE.</b>
	 *
	 * @param indeterminate
	 *            TRUE to activate loading mode. FALSE to activate progress
	 *            mode.
	 */
	...
	Animator indeterminedAnimator;
	private void startAnimation() {
		stopAnimation();
		indeterminedAnimator = getAnimator();
		indeterminedAnimator.start();
	}
	...
	private Animator getAnimator() {
		...
		ObjectAnimator indeterminateAnimation = ObjectAnimator.ofFloat(this, CircularProgressDrawable.PROGRESS_PROPERTY, 0, 720);
		indeterminateAnimation.setDuration(1500);
		indeterminateAnimation.setRepeatCount(-1);

		return indeterminateAnimation;
	}
	 ...
	 *
	 * @param outlineColor
	 *            Outline color in #AARRGGBB format.
	 */
	 ...
	 *
	 * @param centerColor
	 *            Inner circle color in #AARRGGBB format.
	 */
